...
if (isset($_GET['no_service'])) {
    ...
    $select = mysqli_query($koneksi, "SELECT * FROM service JOIN pelanggan on pelanggan.id_pelanggan = service.id_pelanggan WHERE progres IN ('Di Ambil') AND no_service= '$nomor'");
